...
- 2026-08-24 PR #45 CI RED: the GitHub runner lacked the required FFmpeg executable, so the media integration fixture could not be created. CI now installs FFmpeg explicitly; tests remain mandatory and do not skip when the runtime is absent.
