...
- 2026-08-25, final local gate: lint PASS; production build PASS; full deterministic suite PASS (31 files / 179 tests). The first run exposed a local macOS provenance stall in the bundled Intel FFprobe binary; clearing that untracked dependency attribute restored the unchanged media-sync probes, including the previously timing-out case.
